...
use OpenAPIValidation\PSR7\CallbackAddress;
use OpenAPIValidation\PSR7\CallbackRequestValidator;
...
final class CallbackRequestTest extends BaseValidatorTest
{
    ...
    private function createRequest(string $body) : RequestInterface
    {
        ...
        return new Request('post', 'https://some-callback-uri', $headers, $body);
    }
